...
public class MagicLeap_WorldScale : MonoBehaviour
{

    public MagicLeap_NewController steamCtlMain;
    public MagicLeap_NewController steamCtlAlt;
    ...
    private void attachTargetOne(ref MagicLeap_NewController ctl) {
